                ...
                if(flt.geometry.type == 'LineString'):
                    ...
                    if(strike > fault_min_len):
                        ...
                        if(c_l['fdipdir_flag'] == 'num'  ):
                            if( pd.notna( flt[c_l['fdipdir']]) and flt[c_l['fdipdir']]!='-999'):
                        ...
                        elif (not str(flt[c_l['fdipdir']]) == 'None' and not str(float(flt[c_l['fdip']])) == c_l['fdipnull'] and flt[c_l['fdipdir']]!='-999'):
                            dotprod = degrees(acos(
                                (-dlsx*dip_dirs[flt[c_l['fdipdir']]][0])+(dlsy*dip_dirs[flt[c_l['fdipdir']]][1])))
                            if(dotprod > 45):
                                fault_dip = -fault_dip
                        else:
                            azimuth=azimuth_fault
