...
class DeformationHistory(object):
    def __init__(self):
        ...
        faultColumns = numpy.dtype([
            ('faultId',int),('name',str),('minAge',float),('maxAge',float),
            ('group',str),('avgDisplacement',float),('avgDownthrowDir',float),
            ('influenceDirection',float),('verticalRadius',float),('horizontalRadius',float),
            ('colour',str),('centreX',float),('centreY',float),('centreZ',float),
            ('avgSlipDirX',float),('avgSlipDirY',float),('avgSlipDirZ',float),
            ('avgNormalX',float),('avgNormalY',float),('avgNormalZ',float)
        ])
        ...
        foldColumns = numpy.dtype([
            ('faultId',int),('name',str),('minAge',float),('maxAge',float),
            ('periodic',bool),('wavelength',float),('amplitude',float),
            ('asymmetry',bool),('asymmetryShift',float),('secondaryWavelength',float),
