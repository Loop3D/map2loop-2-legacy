...
class Config(object):
    ...
    def calc_depth_grid(self, cover_workflow):
        ...
        dtb_clip = os.path.join(self.output_path, 'young_cover_grid_clip.tif')
    ...
    def extract_drillholes(self, drillhole_file):
        ...
        if(len(dh) > 0):
            ...
            all_contacts.to_csv(os.path.join(
                self.tmp_path, 'contacts4.csv'), index=None, header=True)
