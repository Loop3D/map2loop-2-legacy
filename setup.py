...
cpp_src = []
for file in os.listdir("/map2loop-2/maps/map2model_cpp/src"):
    cpp_src.append(str('/map2loop-2/maps/map2model_cpp/src/' + file))
...
ext_modules = [
    Extension(
        ...
        include_dirs=[
            get_pybind_include(),
            '/map2loop-2/maps/map2model_cpp/include'
        ],
        language='c++'
    ),
]
